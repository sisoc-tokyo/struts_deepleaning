...
public class ServletFilterForMLCmd implements javax.servlet.Filter {
	...
	private static final String ML_PATH = "/root/anaconda3/struts_ml_non_rest/log_class_not_rest.py";
	...
	private int getMLResult(String targetStr) {
		...
		try {
			ProcessBuilder pb= new java.lang.ProcessBuilder(java.util.Arrays.asList("/root/.pyenv/shims/python",ML_PATH,targetStr));
			Process process =pb.start();
			process.waitFor();
			resCode = process.exitValue();
